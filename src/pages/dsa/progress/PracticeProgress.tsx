...
export const PracticeProgressView: React.FC<{ data: CatalogProgress }> = ({ data }) => (
...
export const PracticeProgressSkeleton: React.FC = () => (
  <Card>
    <CardHeader>
...
const PracticeProgress: React.FC = () => {
  ...
  if (isLoading || !data) return <PracticeProgressSkeleton />;

  return <PracticeProgressView data={data} />;
};
