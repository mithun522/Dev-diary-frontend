...
const TestResultsPanel: React.FC<TestResultsPanelProps> = ({ result }) => {
  ...
  return (
    <div className="space-y-3" data-cy="practice-results">
      <div className="flex items-center gap-3">
        <Badge className={STATUS_BADGE[result.status]} data-cy="practice-results-status">
