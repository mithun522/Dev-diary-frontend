      ...
      <Dialog.Portal>
        ...
        >
          ...
          {problemId && isLoadingDetail ? (
            <AdminCatalogFormSkeleton />
          ) : (
            <form
              className={`space-y-4 transition-opacity duration-200 ${
                isFetchingDetail ? "opacity-50 pointer-events-none" : "opacity-100"
              }`}
...
// Mirrors the form's real layout (label + input pairs, a couple of textareas, a checkbox row,
// and a test case card) so the modal doesn't jump/reflow once the problem detail loads.
const AdminCatalogFormSkeleton: React.FC = () => (
  <div className="space-y-4" data-cy="admin-catalog-form-loading">
